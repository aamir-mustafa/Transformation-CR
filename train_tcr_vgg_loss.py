...
def checkpoint(epoch):
    models_out_folder= 'models/Perception/Supervised_10percent_UN'
...
def save_images():
    ...
    model = torch.load('models/Perception/Supervised_10percent_UN/model_epoch_30.pth')
    if opt.cuda:
        model = model.cuda()
    ...
    #    print(input_image)
        output_folder= 'output/Perception/Supervised_10percent_UN'
